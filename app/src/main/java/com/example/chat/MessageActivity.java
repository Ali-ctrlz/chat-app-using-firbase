    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgSend.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view) {
                FirebaseDatabase.getInstance().getReference("messages/" + chatRoomId).push().setValue(new Messages(FirebaseAuth.getInstance().getCurrentUser().getEmail(), emailOfRoommate, edtMessageInput.getText().toString()));
                edtMessageInput.setText("");
            }
        });

        messageAdapter=new MessageAdapter(messages,getIntent().getStringExtra("user_pp"),getIntent().getStringExtra("image_of_roommate"),MessageActivity.this);
